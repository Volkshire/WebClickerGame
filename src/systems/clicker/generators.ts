...
export const GENERATORS: readonly GeneratorDefinition[] = [
  ...
  },
  {
    ...
    flavor: 'The fire never sleeps. Neither do the souls that fuel it.',
    baseCost: 25000000000,
    growthRate: 1.15,
    productionPerSecond: 250000000,
  },
  {
    id: 'necrotic-engine',
    name: 'Necrotic Engine',
    flavor: 'A machine that runs on decay. Perpetual motion, at a price.',
    baseCost: 250000000000,
    growthRate: 1.15,
    productionPerSecond: 2500000000,
  },
  {
    id: 'soul-reactor',
    name: 'Soul Reactor',
    flavor: 'Fission of the spirit. Clean energy, if you ignore the screams.',
    baseCost: 2500000000000,
    growthRate: 1.15,
    productionPerSecond: 25000000000,
  },
  {
    id: 'deathwork-nexus',
    name: 'Deathwork Nexus',
    flavor: 'All endings converge here. The output is... considerable.',
    baseCost: 25000000000000,
    growthRate: 1.15,
    productionPerSecond: 250000000000,
  },
  {
    id: 'worldheart',
    name: 'Worldheart',
    flavor: 'The pulse of a dying world. One beat, and empires fall.',
    baseCost: 250000000000000,
    growthRate: 1.15,
    productionPerSecond: 2500000000000,
  },
];
